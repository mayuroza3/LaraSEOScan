    ...
    <div class="main-content" style="{{ Auth::check() ? '' : 'margin-left: 0 !important;' }}">
        ...
        <div class="top-navbar d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                ...
                @endauth
                <a class="d-flex align-items-center text-decoration-none text-white fw-bold fs-4 me-3" href="{{ route('scan.create') }}">
                    <i class="bi bi-shield-shaded text-primary me-2 fs-3"></i> LaraSEOScan
                </a>
            </div>
            ...
            <div>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown me-2 position-relative">
                        <button class="btn btn-link text-muted text-decoration-none dropdown-toggle fw-semibold p-0 hover-white" type="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                            Free Tools <i class="bi bi-chevron-down ms-1" style="font-size: 0.75rem;"></i>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark shadow border-0 mt-2" style="max-height: 380px; overflow-y: auto; min-width: 250px; background: rgba(15, 23, 42, 0.95); border: 1px solid rgba(255, 255, 255, 0.08) !important; right: 0; left: auto;">
                            <li><a class="dropdown-item py-2 fw-bold text-white border-bottom border-secondary border-opacity-10" href="{{ route('landing.hub') }}"><i class="bi bi-grid-fill me-2 text-primary"></i> Browse All Tools</a></li>
                    ...
                    <a href="{{ route('login') }}" class="text-decoration-none text-muted fw-semibold hover-white">Log In</a>
        ...
        <!-- Premium Footer -->
        <footer class="py-5 text-muted border-top bg-transparent" style="font-size: 0.85rem;">
            <div class="container">
                <div class="row gy-4 mb-4">
                    <div class="col-md-4">
                        <a class="d-flex align-items-center text-decoration-none text-white fw-bold fs-5 mb-3" href="{{ route('scan.create') }}">
                            <i class="bi bi-shield-shaded text-primary me-2"></i> LaraSEOScan
                        </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 offset-lg-1">
                        <h6 class="text-uppercase text-white fw-bold mb-3" style="font-size: 0.75rem; letter-spacing: 0.05em;">Free SEO Tools</h6>
                        <ul class="list-unstyled d-flex flex-column gap-2">
                            <li><a href="{{ route('landing.seo-checker') }}" class="text-decoration-none text-muted hover-white">Website SEO Checker</a></li>
                            <li><a href="{{ route('landing.meta-tag-checker') }}" class="text-decoration-none text-muted hover-white">Meta Tag Checker</a></li>
                            <li><a href="{{ route('landing.robots-txt-checker') }}" class="text-decoration-none text-muted hover-white">Robots.txt Checker</a></li>
                            <li><a href="{{ route('landing.sitemap-checker') }}" class="text-decoration-none text-muted hover-white">Sitemap Checker</a></li>
                            <li><a href="{{ route('landing.image-seo-checker') }}" class="text-decoration-none text-muted hover-white">Image SEO Checker</a></li>
                        </ul>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3">
                        <h6 class="text-uppercase text-white fw-bold mb-3" style="font-size: 0.75rem; letter-spacing: 0.05em;">On-Page Audits</h6>
                        <ul class="list-unstyled d-flex flex-column gap-2">
                            <li><a href="{{ route('landing.title-tag-checker') }}" class="text-decoration-none text-muted hover-white">Title Tag Checker</a></li>
                            <li><a href="{{ route('landing.meta-description-checker') }}" class="text-decoration-none text-muted hover-white">Meta Description Checker</a></li>
                            <li><a href="{{ route('landing.h1-checker') }}" class="text-decoration-none text-muted hover-white">H1 Tag Checker</a></li>
                            <li><a href="{{ route('landing.broken-link-checker') }}" class="text-decoration-none text-muted hover-white">Broken Link Checker</a></li>
                            <li><a href="{{ route('landing.schema-markup-checker') }}" class="text-decoration-none text-muted hover-white">Schema Markup Validator</a></li>
                        </ul>
                    </div>
                </div>
                <div class="border-top border-secondary border-opacity-10 pt-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                    <span class="small">&copy; {{ date('Y') }} LaraSEOScan. All rights reserved.</span>
                    <div class="small">
                        <a href="{{ route('legal.privacy') }}" class="text-decoration-none text-muted mx-2 hover-white">Privacy Policy</a>
                        <a href="{{ route('legal.terms') }}" class="text-decoration-none text-muted mx-2 hover-white">Terms of Service</a>
                        <a href="{{ route('legal.cookies') }}" class="text-decoration-none text-muted mx-2 hover-white">Cookie Policy</a>
                    </div>
                </div>
            </div>
        </footer>
