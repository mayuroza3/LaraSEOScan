...
<div class="container-fluid px-0 py-2">
    <div class="mb-5">
        <h2 class="fw-bold mb-1 text-white">Account Settings</h2>
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-12 col-xl-8">
            <div class="card border-0 shadow-sm p-4 mb-4">
                <h5 class="fw-bold text-white mb-4"><i class="bi bi-person-badge text-primary me-2"></i> Profile Information</h5>
                <div class="max-w-xl">
            ...
            <!-- Password Card -->
            <div class="card border-0 shadow-sm p-4 mb-4">
                <h5 class="fw-bold text-white mb-4"><i class="bi bi-shield-lock text-warning me-2"></i> Update Password</h5>
                <div class="max-w-xl">
