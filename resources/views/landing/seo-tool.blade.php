...
<div class="row justify-content-center py-5">
    ...
    <!-- Left Navigation Directory (Redesigned Sidebar Navigator) -->
    <div class="col-lg-3 mb-5 mb-lg-0">
        <div class="sticky-top" style="top: 100px; padding-right: 15px;">
            <h6 class="text-uppercase text-muted fw-bold font-monospace mb-3 px-3" style="font-size: 0.7rem; letter-spacing: 0.1em; color: var(--text-muted) !important;">SEO Tools Directory</h6>
            <div class="d-flex flex-column gap-1">
                <a href="{{ route('landing.seo-checker') }}" class="directory-link rounded-3 {{ $tool === 'seo-checker' ? 'active' : '' }}">
                    <i class="bi bi-search me-2"></i> Website SEO Checker
                </a>
                <a href="{{ route('landing.meta-tag-checker') }}" class="directory-link rounded-3 {{ $tool === 'meta-tag-checker' ? 'active' : '' }}">
                    <i class="bi bi-tags me-2"></i> Meta Tag Checker
                </a>
                <a href="{{ route('landing.meta-description-checker') }}" class="directory-link rounded-3 {{ $tool === 'meta-description-checker' ? 'active' : '' }}">
                    <i class="bi bi-file-earmark-text me-2"></i> Meta Description Checker
                </a>
                <a href="{{ route('landing.title-tag-checker') }}" class="directory-link rounded-3 {{ $tool === 'title-tag-checker' ? 'active' : '' }}">
                    <i class="bi bi-type-h1 me-2"></i> Title Tag Checker
                </a>
                <a href="{{ route('landing.h1-checker') }}" class="directory-link rounded-3 {{ $tool === 'h1-checker' ? 'active' : '' }}">
                    <i class="bi bi-hash me-2"></i> H1 Tag Checker
                </a>
                <a href="{{ route('landing.broken-link-checker') }}" class="directory-link rounded-3 {{ $tool === 'broken-link-checker' ? 'active' : '' }}">
                    <i class="bi bi-link-45deg me-2"></i> Broken Link Checker
                </a>
                <a href="{{ route('landing.robots-txt-checker') }}" class="directory-link rounded-3 {{ $tool === 'robots-txt-checker' ? 'active' : '' }}">
                    <i class="bi bi-robot me-2"></i> Robots.txt Checker
                </a>
                <a href="{{ route('landing.sitemap-checker') }}" class="directory-link rounded-3 {{ $tool === 'sitemap-checker' ? 'active' : '' }}">
                    <i class="bi bi-diagram-3 me-2"></i> Sitemap Checker
                </a>
                <a href="{{ route('landing.schema-markup-checker') }}" class="directory-link rounded-3 {{ $tool === 'schema-markup-checker' ? 'active' : '' }}">
                    <i class="bi bi-code-slash me-2"></i> Schema Checker
                </a>
                <a href="{{ route('landing.open-graph-checker') }}" class="directory-link rounded-3 {{ $tool === 'open-graph-checker' ? 'active' : '' }}">
                    <i class="bi bi-share me-2"></i> Open Graph Checker
                </a>
                <a href="{{ route('landing.image-seo-checker') }}" class="directory-link rounded-3 {{ $tool === 'image-seo-checker' ? 'active' : '' }}">
                    <i class="bi bi-image me-2"></i> Image SEO Checker
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-9 col-xl-8">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page" style="font-size: 13px;">{{ $data['header'] }}</li>
            </ol>
        </nav>
        ...
        <div class="text-center mb-5 mt-2">
            ...
            <h1 class="fw-bold mb-3">{{ $data['header'] }}</h1>
        ...
        <div class="card border-0 p-4 p-md-5 mb-5" style="background: var(--bg-surface-1) !important;">
            <form method="POST" action="{{ route('scan.submit') }}">
                ...
                <div class="mb-4">
                    <div class="input-group border border-secondary border-opacity-30 rounded-3 overflow-hidden shadow-inner p-1 bg-dark bg-opacity-30" style="height: 60px;">
                        <span class="input-group-text bg-transparent border-0 text-muted px-3"><i class="bi bi-globe2 fs-4 text-muted"></i></span>
                        <input type="url" class="form-control bg-transparent border-0 text-white ps-2 fs-5" name="url" id="url" placeholder="https://example.com" required style="outline: none; box-shadow: none;">
            ...
            <div class="text-center mt-4 pt-3 border-top border-secondary border-opacity-10 text-muted small">
                Analyzes: <strong class="text-white">{{ implode(' • ', array_keys($data['features'])) }}</strong>
            </div>
        </div>

        <!-- Dynamic Visual Hero Artifact per page -->
        <div class="card border-0 p-4 mb-5" style="background: var(--bg-surface-1) !important;">
            <h5 class="text-white fw-bold mb-3" style="font-size: 1rem;"><i class="bi bi-cpu text-primary me-2"></i> Live Analyzer Simulator</h5>
            
            @if(in_array($tool, ['meta-tag-checker', 'title-tag-checker', 'meta-description-checker']))
                <!-- Metadata Visual Mockup -->
                <div class="p-4 rounded-4 bg-dark bg-opacity-40 border border-secondary border-opacity-15">
                    ...
                    <div class="p-3 rounded bg-secondary bg-opacity-5 mb-2 border border-secondary border-opacity-5">
                        <span class="text-muted font-monospace small d-block mb-1">&lt;title&gt;</span>
                        <strong class="text-white fs-5">{{ $data['title'] }}</strong>
                    </div>
                    <div class="p-3 rounded bg-secondary bg-opacity-5 mb-2 border border-secondary border-opacity-5">
                        <span class="text-muted font-monospace small d-block mb-1">&lt;meta name="description"&gt;</span>
                        <span class="text-white small">{{ $data['meta_description'] }}</span>
                    </div>
                    <div class="d-flex gap-2">
                        <span class="badge bg-secondary bg-opacity-10 text-muted">Title: {{ strlen($data['title']) }} chars</span>
                        <span class="badge bg-secondary bg-opacity-10 text-muted">Desc: {{ strlen($data['meta_description']) }} chars</span>
                    </div>
                </div>

            @elseif($tool === 'robots-txt-checker')
                <!-- Robots.txt File Simulator -->
                <div class="p-4 rounded-4 bg-dark bg-opacity-40 border border-secondary border-opacity-15 font-monospace">
                    <div class="d-flex align-items-center justify-content-between mb-3 border-bottom border-secondary border-opacity-10 pb-2">
                    ...
                    <div class="p-3 rounded bg-secondary bg-opacity-5 border border-secondary border-opacity-5 text-info">
                        <div>User-agent: *</div>
                        <div>Disallow: /admin/</div>
                        <div>Disallow: /config/</div>
                        <div class="text-white mt-2">Allow: /</div>
            ...
            @elseif($tool === 'h1-checker')
                ...
                <div class="p-4 rounded-4 bg-dark bg-opacity-40 border border-secondary border-opacity-15">
                    ...
                    <div class="p-3 rounded bg-secondary bg-opacity-5 border border-secondary border-opacity-5">
                        <div class="mb-2">
                            <span class="badge bg-primary me-2">H1</span> <strong class="text-white">Main Page Title (Only 1 Recommended)</strong>
                        </div>
                        <div class="ms-4 mb-2 border-left border-secondary border-opacity-20 ps-3">
                            <span class="badge bg-secondary text-light me-2">H2</span> <span class="text-light">Primary Section Header</span>
                        </div>
                        <div class="ms-5 border-left border-secondary border-opacity-20 ps-3">
            ...
            @elseif($tool === 'sitemap-checker')
                ...
                <div class="p-4 rounded-4 bg-dark bg-opacity-40 border border-secondary border-opacity-15 font-monospace">
                    ...
                    <div class="p-3 rounded bg-secondary bg-opacity-5 border border-secondary border-opacity-5 text-muted small">
                        <div>&lt;urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"&gt;</div>
                        <div class="ms-3 text-info">&lt;url&gt;</div>
                        <div class="ms-4 text-white">&lt;loc&gt;https://yourdomain.com/&lt;/loc&gt;</div>
                        <div class="ms-4 text-white">&lt;lastmod&gt;{{ date('Y-m-d') }}&lt;/lastmod&gt;</div>
                        <div class="ms-3 text-info">&lt;/url&gt;</div>
                        <div>&lt;/urlset&gt;</div>
                    </div>
                </div>
            ...
            @elseif($tool === 'broken-link-checker')
                ...
                <div class="p-4 rounded-4 bg-dark bg-opacity-40 border border-secondary border-opacity-15">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <div class="d-flex justify-content-between p-2 rounded bg-secondary bg-opacity-5 border border-secondary border-opacity-5 align-items-center">
                ...
                <div class="p-4 rounded-4 bg-dark bg-opacity-40 border border-secondary border-opacity-15">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center">
                            <div class="d-inline-block p-4 rounded-circle bg-secondary bg-opacity-5 border border-secondary border-opacity-20 mb-2">
                                <h2 class="fw-bold mb-0 text-primary">-- / 100</h2>
                            </div>
                            <div class="text-muted small">Technical Health Rating</div>
                        </div>
                        <div class="col-md-6">
                            <ul class="list-unstyled mb-0 d-flex flex-column gap-2 text-light small">
        ...
        <div class="card border-0 p-4 p-md-5 mb-4" style="background: var(--bg-surface-1) !important;">
            <h2 class="fw-bold text-white mb-3" style="font-size: 1.75rem;">{{ $data['h2_title'] }}</h2>
            <p class="text-muted mb-4 fs-6 leading-relaxed">{{ $data['h2_desc'] }}</p>
            
            <div class="row g-4 mt-2">
                @foreach($data['features'] as $title => $desc)
                    <div class="col-md-4">
                        <div class="p-3 rounded-4 bg-secondary bg-opacity-10 border border-secondary border-opacity-10 h-100">
                            <h5 class="text-white fw-bold mb-2" style="font-size: 1rem;"><i class="bi bi-check2-circle text-primary me-2"></i> {{ $title }}</h5>
        ...
        <div class="card border-0 p-4 p-md-5 mb-4" style="background: var(--bg-surface-1) !important;">
            <h2 class="fw-bold text-white mb-4" style="font-size: 1.75rem;"><i class="bi bi-patch-check text-primary me-2"></i> What Does This Audit Validate?</h2>
            @foreach($data['checks'] as $check)
                <div class="mb-4">
                    <h3 class="fw-bold text-white fs-5"><i class="bi bi-check2-circle text-primary me-2"></i> {{ $check['title'] }}</h3>
        ...
        <div class="card border-0 p-4 p-md-5 mb-4" style="background: var(--bg-surface-1) !important;">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h3 class="fw-bold text-white mb-0"><i class="bi bi-code-slash text-primary me-2"></i> {{ $data['code_title'] ?? 'Technical Code Example' }}</h3>
            ...
            <div class="bg-dark bg-opacity-50 p-4 rounded-4 border border-secondary border-opacity-15 position-relative mb-2">
        ...
        <div class="card border-0 p-4 p-md-5 mb-4" style="background: var(--bg-surface-1) !important;">
            <h3 class="fw-bold text-white mb-4"><i class="bi bi-exclamation-triangle text-primary me-2"></i> Common Issues & Fixes</h3>
        ...
        <div class="py-4 mb-4">
            <h3 class="fw-bold text-white mb-4"><i class="bi bi-question-circle text-primary me-2"></i> Frequently Asked Questions</h3>
            <div class="accordion border-0 bg-transparent" id="faqAccordion">
                @foreach($data['faqs'] as $index => $faq)
                    <div class="accordion-item border-0 bg-transparent mb-3 border-bottom border-secondary border-opacity-15 pb-3">
                        <h4 class="accordion-header" id="headingFaq-{{ $index }}">
                            <button class="accordion-button collapsed bg-transparent text-white border-0 py-2 px-0 shadow-none hover-white" 
                                    type="button" 
        ...
        <div class="card border-0 p-4 p-md-5 mb-4" style="background: var(--bg-surface-1) !important;">
            <h3 class="fw-bold text-white mb-4"><i class="bi bi-gear-wide-connected text-primary me-2"></i> How the {{ $data['header'] }} Works</h3>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="d-flex align-items-start">
                        <div class="badge bg-primary bg-opacity-10 text-primary rounded-circle px-3 py-2 me-3 fs-5">1</div>
                        <div>
                            <h5 class="text-white fw-bold mb-2">Enter URL</h5>
                ...
                <div class="col-md-4">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <h5 class="text-white fw-bold mb-2">Real-Time Audit</h5>
                ...
                <div class="col-md-4">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <h5 class="text-white fw-bold mb-2">Get Actionable Tips</h5>
        ...
        <div class="card border-0 p-4 p-md-5 mb-4" style="background: var(--bg-surface-1) !important;">
            <h3 class="fw-bold text-white mb-2"><i class="bi bi-grid-fill text-primary me-2"></i> Everything You Need to Master Technical SEO</h3>
            ...
            <div class="row g-3">
                <div class="col-md-6 col-lg-4">
                    <div class="p-3 rounded-4 bg-secondary bg-opacity-10 h-100">
                        ...
                        <h6 class="text-white fw-bold">Deep Crawl Engine</h6>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="p-3 rounded-4 bg-secondary bg-opacity-10 h-100">
                        ...
                        <h6 class="text-white fw-bold">Broken Link Detection</h6>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="p-3 rounded-4 bg-secondary bg-opacity-10 h-100">
                        ...
                        <h6 class="text-white fw-bold">Performance Auditing</h6>
        ...
        <div class="card border-0 p-4 p-md-5 mb-4 text-center" style="background: var(--bg-surface-1) !important;">
            <h3 class="fw-bold text-white mb-2"><i class="bi bi-cpu text-primary me-2"></i> Why Developers Choose LaraSEOScan</h3>
            ...
            <div class="row g-4 text-start">
                <div class="col-md-4">
                    <div class="p-3 rounded-4 bg-secondary bg-opacity-10 h-100">
                        ...
                        <h5 class="text-white fw-bold" style="font-size: 1rem;">Developer First</h5>
                ...
                <div class="col-md-4">
                    <div class="p-3 rounded-4 bg-secondary bg-opacity-10 h-100">
                        ...
                        <h5 class="text-white fw-bold" style="font-size: 1rem;">Crawl Without Limits</h5>
                ...
                <div class="col-md-4">
                    <div class="p-3 rounded-4 bg-secondary bg-opacity-10 h-100">
                        ...
                        <h5 class="text-white fw-bold" style="font-size: 1rem;">Privacy Focused</h5>
        ...
        <div class="p-4 mb-4 rounded-4 border border-secondary border-opacity-10" style="background: rgba(16, 26, 44, 0.3) !important;">
            <p class="mb-0 text-muted small text-center">
                Need to check only your page title? Try our <a href="{{ route('landing.title-tag-checker') }}" class="text-primary text-decoration-none">Title Tag Checker</a>. 
                Want to validate your meta description separately? Use our <a href="{{ route('landing.meta-description-checker') }}" class="text-primary text-decoration-none">Meta Description Checker</a>. 
                Need a broader audit? Run a full <a href="{{ route('landing.seo-checker') }}" class="text-primary text-decoration-none">Website SEO Checker</a>.
            </p>
        </div>
